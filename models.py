...
class Business(Base):
    ...
    billing_country: Mapped[Optional[str]] = mapped_column(Text, default="ua")
...
class GlobalPaymentSettings(Base):
    ...
    us_bank_name: Mapped[Optional[str]] = mapped_column(Text)
    us_account_number: Mapped[Optional[str]] = mapped_column(Text)
    us_routing_number: Mapped[Optional[str]] = mapped_column(Text)
    us_swift: Mapped[Optional[str]] = mapped_column(Text)
    us_receiver_name: Mapped[Optional[str]] = mapped_column(Text)
    us_qr_url: Mapped[Optional[str]] = mapped_column(Text)
    us_payment_note: Mapped[Optional[str]] = mapped_column(Text)
